            ...
            <div class="wrapper">
              <form action="scripts_bbdd/realizar_reserva.php?fechallegada=<?php echo $_POST['fechallegada']; ?>&fechasalida=<?php echo $_POST['fechasalida']; ?>&pension=<?php echo $_POST['pension']; ?>" id="form2" method="post">
                ...
                <fieldset>
                  ...
                  <div class="row"><br>Identificación: <input type="text" name="identificacion" id="identificacion" required minlength="9" maxlength="9"></div><br>
                  <div class="row">Fecha de Nacimiento: <input type="date" name="fechanacimiento" id="fechanacimiento" required></div>
                  <div class="row"><br>Telefono: <input type="text" name="telf" id="telf" required minlength="9" maxlength="9"></div>
                  <div class="row"><br>Email:<input type="email" name="mail" id="mail" required> </div>
                  <div class="row"><br>Nacionalidad:
                  ...
                  <p> <div class="wrapper"></a><input type="reset" class="button2"></a><input type="submit" class="button2" value="Reservar"></div>
                </fieldset>
              </form>
              <img src="images/reserva_img.jpg" width="600" height="515">
              </div>
            </div>
          </div>
        </div>
